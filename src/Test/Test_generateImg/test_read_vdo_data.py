"""
อ่านข้อมูลจากไฟล์ csv ที่เก็บโดยไฟล์ test_write_vdo_data.py
...
if __name__ == '__main__':
    data = read_from_csv(r'C:\Users\IAMMAI\Desktop\githubProject\NailsDetection\src\database\data_07112022_102958.csv')
